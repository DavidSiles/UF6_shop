...
public class DaoImplMongoDB implements Dao{
	...
	public void connect() {
		...
		mongoDatabase = mongoClient.getDatabase("SHOPSILES");
	...
	public Employee getEmployee(int employeeId, String password) {
		...
		if(document == null) {
			document = new Document("_id", new ObjectId()).append("user", employeeId).append("password", password);
	...
	public boolean addProduct(String name, Amount price, int stock, boolean avaiblable) {
		...
		Document document = new Document("_id", new ObjectId()).append("name", name).append("wholesalerPrice", new Document("value", price.getValue()).append("currency", price.getCurrency())).append("available", avaiblable).append("stock", stock).append("id", newId);
		collection.insertOne(document);
